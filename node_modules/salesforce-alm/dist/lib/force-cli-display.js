    ...
    if (logs.length === 0) {
        ...
        logApi.table(logs, {
            columns: [
                ...
                { key: 'DurationMilliseconds', label: Messages.get('DisplayHeaderDuration') },
...
exports.soqlQuery = function (columns, records) {
    prepNullValues(records);
    logApi.table(records, { columns });
    logApi.log(logApi.color.bold(Messages.get('DisplayQueryRecordsRetrieved', records.length)));
};
