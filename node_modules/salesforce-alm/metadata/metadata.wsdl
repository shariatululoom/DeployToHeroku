...
<!--
Salesforce.com Metadata API version 39.0
...
<definitions targetNamespace="http://soap.sforce.com/2006/04/metadata" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns="http://schemas.xmlsoap.org/wsdl/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="http://soap.sforce.com/2006/04/metadata">
    <types>
        <xsd:schema elementFormDefault="qualified" targetNamespace="http://soap.sforce.com/2006/04/metadata">
            ...
            <xsd:complexType name="CustomExperience">
                <xsd:complexContent>
                    <xsd:extension base="tns:Metadata">
                        <xsd:sequence>
                            <xsd:element name="allowInternalUserLogin" type="xsd:boolean"/>
                            <xsd:element name="branding" minOccurs="0" type="tns:CustomExperienceBranding"/>
                            <xsd:element name="changePasswordEmailTemplate" type="xsd:string"/>
                            ...
                            <xsd:element name="enableErrorPageOverridesForVisualforce" type="xsd:boolean"/>
                            <xsd:element name="forgotPasswordEmailTemplate" minOccurs="0" type="xsd:string"/>
                            <xsd:element name="picassoSite" minOccurs="0" type="xsd:string"/>
                            <xsd:element name="sObjectType" type="xsd:string"/>
                            <xsd:element name="sendWelcomeEmail" type="xsd:boolean"/>
                            <xsd:element name="site" type="xsd:string"/>
                            <xsd:element name="siteAsContainerEnabled" type="xsd:boolean"/>
                            <xsd:element name="tabs" minOccurs="0" type="tns:CustomExperienceTabSet"/>
                            <xsd:element name="urlPathPrefix" minOccurs="0" type="xsd:string"/>
                            <xsd:element name="welcomeEmailTemplate" minOccurs="0" type="xsd:string"/>
                        </xsd:sequence>
                    </xsd:extension>
                </xsd:complexContent>
            </xsd:complexType>
            <xsd:complexType name="CustomExperienceBranding">
                <xsd:sequence>
            ...
            <xsd:complexType name="CustomExperienceTabSet">
                <xsd:sequence>
            ...
            <xsd:complexType name="EventType">
                <xsd:complexContent>
                    <xsd:extension base="tns:Metadata">
                        <xsd:sequence>
                            <xsd:element name="description" minOccurs="0" type="xsd:string"/>
                            <xsd:element name="fields" minOccurs="0" maxOccurs="unbounded" type="tns:EventTypeParameter"/>
                            <xsd:element name="label" type="xsd:string"/>
                        </xsd:sequence>
                    </xsd:extension>
                </xsd:complexContent>
            ...
            <xsd:complexType name="InsightType">
                <xsd:complexContent>
                    <xsd:extension base="tns:Metadata">
                        <xsd:sequence>
                            <xsd:element name="defaultTrendType" type="tns:InsightTrendType"/>
                            <xsd:element name="description" type="xsd:string"/>
                            <xsd:element name="isProtected" minOccurs="0" type="xsd:boolean"/>
                            <xsd:element name="masterLabel" type="xsd:string"/>
                            <xsd:element name="parentType" type="tns:InsightParentType"/>
                            <xsd:element name="title" type="xsd:string"/>
                        </xsd:sequence>
                    </xsd:extension>
                </xsd:complexContent>
            ...
            <xsd:simpleType name="ExtendedErrorCode">
                <xsd:restriction base="xsd:string">
                    <xsd:enumeration value="FTEST_EXTENSION_CODE_FOR_TEST">
                        <xsd:annotation>
                            <xsd:documentation>Errors with this extended error code have the following properties: FTestName, ftestClass</xsd:documentation></xsd:annotation></xsd:enumeration></xsd:restriction></xsd:simpleType>
    ...
    <service name="MetadataService">
        ...
        <port binding="tns:MetadataBinding" name="Metadata">
            <soap:address location="http://login.salesforce.com/services/Soap/m/39.0"/>
        </port>
    </service>
</definitions>