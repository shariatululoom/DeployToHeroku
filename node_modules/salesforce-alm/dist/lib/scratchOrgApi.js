...
const apphub = require(path.join(__dirname, 'apphub', 'appHubApi'));
...
class Org {
    ...
    getConfig() {
        ...
        return this.resolveDefaultName()
            ...
            if (accessTokenMatch) {
                ...
                return srcDevUtil.getGlobalConfig(`${username}.json`)
     ...
     */
    getAppHub() {
        return this.getDevHubOrg()
            .then(devHubOrg => apphub.getAppHub(devHubOrg));
    }
    /**
