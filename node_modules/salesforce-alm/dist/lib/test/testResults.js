...
class TestResults {
    constructor(testrunid, startTime, suitename, tests, runResultSummaries, config, passStr = 'Pass', skipStr = 'Skip') {
        ...
        this.commandTime = moment().diff(this.startTime, true);
        // start time per run summary
        this.testStartTime = runResultSummary !== null ?
            moment.parseZone(runResultSummary.StartTime).local() : this.startTime;
        // total time per run summary
        this.testTotalTime = runResultSummary !== null ? runResultSummary.TestTime : 0;
        // sum of all test.RunTime
        this.testExecutionTime = runResultSummary !== null && runResultSummary.TestExecutionTime ?
