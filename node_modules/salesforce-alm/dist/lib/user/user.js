...
class User {
    ...
    create(fields = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.force._getConnection(this.org, this.org.config).then((conn) => __awaiter(this, void 0, void 0, function* () {
                ...
                return conn._transport.httpRequest({
                    method: 'POST',
                    url: scimUrl,
                    headers: scimHeaders,
                    body
                    ...
                    if (response.statusCode === 201) {
                        ...
                        this._fields.createddate = moment(respBody.meta.created).valueOf().toString();
                        ...
                        if (errMessage.includes('LICENSE_LIMIT_EXCEEDED')) {
                            ...
                            return this.force.query(this.org, profileQuery)
                                .then((profileQR) => {
                                const profileName = _.get(profileQR, 'records[0].Name');
                                throw almError({ keyName: 'licenseLimitExceeded', bundle: 'user_create' }, profileName);
                            });
                        }
            ...
            yield this.update(_.omit(this._fields, ['username', 'email', 'lastname', 'profileid', 'id', 'createddate']));
            return this;
        });
    }
    ...
    retrieve(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const fields = yield this.force.retrieve(this.org, 'User', userId);
            this._fields = srcDevUtil.toLowerCaseKeys(fields);
            return this;
        });
    }
    ...
    update(fields = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.force.update(this.org, 'User', fields);
            delete fields['Id'];
    ...
    assignPermissionSets(permsetNames) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.isCreated) {
                throw almError({ keyName: 'userNotCreated', bundle: 'user_create' }, 'assigning permission sets.');
            }
            this._permissionSetAssignments = yield Promise.all(permsetNames.map(permsetName => new permissionSetAssignment_1.default(this.org).create(this, permsetName)));
    ...
    assignPassword(password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connection = yield this.force._getConnection(this.org, this.force.config);
            ...
            const orgConfig = yield userOrg.getConfig();
            const pwd = password || User.generatePassword();
            yield connection.soap.setPassword(this.id, pwd);
            this._password = pwd;
            this.logger.info(`Set password: ${pwd} for user: ${this.id}`);
            yield userOrg.saveConfig(Object.assign(orgConfig, { password: pwd }), undefined);
            return this;
        });
    }
    /**
    ...
    static generatePassword() {
        ...
        const pass = Array(PASSWORD_LENGTH - ALL.length).fill(1).map(() => {
            const set = ALL[rand(ALL)];
            return set[rand(set)];
        });
        // Add at least one from each required set to meet minimum requirements
        ALL.forEach(set => { pass.push(set[rand(set)]); });
     ...
     */
    static fetchUsers(org, usernames, fields = ['id', 'username']) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userRecords = _.get(yield org.force.query(org, query), 'records');
