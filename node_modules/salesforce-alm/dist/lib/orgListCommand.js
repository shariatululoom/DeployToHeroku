...
class OrgListCommand {
    ...
    execute(context) {
        ...
        return Org.readAllUserFilenames().then(fileNames => Org.readLocallyValidatedMetaConfigsGroupedByOrgType(fileNames))
            .then((metaConfigs) => {
