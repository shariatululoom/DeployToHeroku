...
const sourceState = {
    ...
    toString(state) {
        switch (state) {
            case sourceState.UNCHANGED: return 'Unchanged';
            case sourceState.CHANGED: return 'Changed';
            case sourceState.DELETED: return 'Deleted';
            case sourceState.NEW: return 'Add';
            case sourceState.DUP: return 'Duplicate';
