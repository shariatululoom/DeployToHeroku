...
// Local
const project = require(path.join(ROOT, 'projectDir'));
const almError = require(path.join(ROOT, 'almError'));
const srcDevUtil = require(path.join(ROOT, 'srcDevUtil'));
...
class ConfigFile {
     ...
     */
    read() {
        return srcDevUtil.readJSON(this.path)
            .then(content => {
     ...
     *
     * @returns {Promise<boolean>} true if the config file exist and has access,
     * false otherwise.
     */
    exist() {
